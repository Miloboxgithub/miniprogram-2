...
Page({
  ...
  getOption: function () {
    ...
    wx.request({
      url: `https://www.aiotcomm.com.cn:18888/api/plugins/telemetry/${entityType}/${entityId}/values/timeseries?keys=lux_data&limit=7&startTs=1718208000000&endTs=1881285384219`,
      method: 'GET',
      header: {
